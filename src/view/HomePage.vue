  ...
  data() {
    return {
      ...
      customerList: [
        ...
        {
          logo: require("@/assets/img/ctru/8.jpg")
        },
        {
          logo: require("@/assets/img/ctru/44.jpg")
        },
        {
          logo: require("@/assets/img/ctru/5.jpg")
        },
        {
          logo: require("@/assets/img/ctru/6.jpg")
        }
      ],
      serverList: [
        {
...
#contactUs {
  color: #fff;
  height: 300px;
  background: url("../assets/img/a.jpg") 0 0 no-repeat;
